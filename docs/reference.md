# shopware-carve reference

This page documents the plugin surfaces and configuration. Start with the [package README](../README.md) for installation and basic use.
...
Pulled in by the plugin's own `composer.json` (`markup-carve/carve-php: ^0.1.9`):
